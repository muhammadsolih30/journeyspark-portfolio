...
const translations = {
  en: {
    ...
    "hero.description":
      "A passionate 17-year-old developer from Uzbekistan, transforming ideas into beautiful web experiences.",
    ...
    "about.bio1":
      "I'm Mukhammadsolikh Abduvosiyev, a 17-year-old junior frontend developer from the beautiful Urgut district of Samarkand, Uzbekistan. My journey into programming began in early 2025, and since then, I've been passionate about creating stunning web experiences.",
    "about.bio2":
      "Before diving into the world of code, I was an athlete - a regional wrestling champion and district-level chess competitor. These experiences taught me discipline, strategic thinking, and the importance of continuous improvement.",
    "about.bio3":
      "Currently, I'm focused on mastering frontend technologies while also learning English to expand my opportunities globally. I believe that with dedication and hard work, anything is possible.",
    ...
    "projects.project1.description":
      "A modern admin dashboard with analytics, product management, and real-time data visualization.",
    ...
    "projects.project4.description":
      "A customizable portfolio template for developers with dark mode and animations.",
    ...
    "journey.ai.description":
      "2-month course on AI and Machine Learning basics",
  ...
  uz: {
    ...
    "hero.name": "Mukhammadsolikh",
    "hero.subtitle":
      "Frontend Dasturchi | React Ishqibozi | Muammolarni Hal Qiluvchi",
    "hero.description":
      "O'zbekistonlik 17 yoshli ishtiyoqli dasturchi, g'oyalarni go'zal veb-tajribalarga aylantirayapman.",
    ...
    "about.bio3":
      "Hozirda men frontend texnologiyalarini o'zlashtirishga e'tibor qaratmoqdaman, shu bilan birga imkoniyatlarimni global miqyosda kengaytirish uchun ingliz tilini o'rganmoqdaman. Ishonaman, fidoyilik va mehnat bilan hamma narsa mumkin.",
    ...
    "skills.subtitle":
      "G'oyalarni hayotga tatbiq etish uchun ishlatadigan vositalarim",
    "skills.frontend": "Frontend",
    "skills.javascript": "JavaScript",
    ...
    "projects.project1.description":
      "Analitika, mahsulot boshqaruvi va real vaqtda ma'lumotlarni vizualizatsiya qilish bilan zamonaviy admin paneli.",
    "projects.project2.title": "Ob-havo Ilovasi",
    "projects.project2.description":
      "Joylashuvga asoslangan ob-havo prognozi va interaktiv xaritalar bilan go'zal ob-havo ilovasi.",
    "projects.project3.title": "Vazifalarni Boshqarish",
    "projects.project3.description":
      "Sudrab-tashlash funksiyasi va jamoa hamkorlik xususiyatlari bilan samaradorlik ilovasi.",
    "projects.project4.title": "Portfolio Shabloni",
    "projects.project4.description":
      "Dasturchilar uchun qorong'i rejim va animatsiyalar bilan moslashtirilgan portfolio shabloni.",
    ...
    "journey.transition.description":
      "Dasturlash karerasini davom ettirishga qaror qildim",
    "journey.frontend.title": "8 Oylik Frontend Kursi",
    "journey.frontend.description":
      "HTML, CSS, JavaScript, React o'zlashtirdim",
    "journey.ai.title": "AI/ML Asoslari",
    "journey.ai.description":
      "Sun'iy intellekt va Machine Learning asoslari bo'yicha 2 oylik kurs",
